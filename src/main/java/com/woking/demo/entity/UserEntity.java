...
public class UserEntity {
	...
	private List<CompanyEntity> listCompanyFollower;
	...
	private List<RecruitmentEntity> listSavejob;

	public void add(RecruitmentEntity recruitmentEntity){
		if(listSavejob == null){
			listSavejob = new ArrayList<>();
		}
		listSavejob.add(recruitmentEntity);
	}
	...
	List<RecruitmentEntity> listAppliedOfUser;
