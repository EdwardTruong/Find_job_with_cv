package com.woking.demo.config;
	...
	public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
		http
				.authorizeHttpRequests(requests -> requests
						.requestMatchers(HttpMethod.GET, "/assets/css/**", "/assets/fonts/**", "/assets/images/**",
								"/assets/upload/**",
								"/assets/js/**", "/assets/new/**", "/assets/scss/**", "/assets/cvs/**")
						.permitAll()
						...
						.requestMatchers(HttpMethod.GET, "/recruitment/category/**", "/recruitment/search/**",
								"/recruitment/searchaddress/**")
						...
						.requestMatchers(HttpMethod.GET, "/save-job/delete/**", "/follow/delete-follow/**",
								"apply/delete/**")
						.hasRole("USER")
						.requestMatchers(HttpMethod.POST, "/save-job/save/**", "/follow/follow-company/**")
						.hasRole("USER")
				...
				.formLogin(form -> form.loginPage("/auth/login").failureUrl("/auth/login-error")
						.loginProcessingUrl("/auth/processLogin").defaultSuccessUrl("/home", true).permitAll())
