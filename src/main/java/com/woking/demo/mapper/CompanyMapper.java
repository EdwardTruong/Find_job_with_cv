...
public class CompanyMapper {
    ...
    public CompanyDto toDto(CompanyEntity entity) { // Extention- Check all application when running because i change a
                                                    // lot. It was delete logo, description ect..
    ...
    public CompanyInfoDto toCompanyInfoDto(CompanyEntity entity) {
