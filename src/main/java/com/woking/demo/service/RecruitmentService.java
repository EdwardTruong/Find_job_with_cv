...
public interface RecruitmentService {
    ...
    Page<RecruitmentResponseFindDto> findReBySearchingTittle(String keySearch, int pageNo, int pageSize);

    List<RecruitmentResponseFindDto> findReBySearchingBar(String keySearch);

    Page<RecruitmentResponseFindDto> findReBySearchingAddress(String keySearch, int pageNo, int pageSize);
}
