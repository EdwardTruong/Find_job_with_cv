...
public class UserController {
	...
	static List<RecruitmentEntity> listUserSaved = new ArrayList<>();
	static List<CompanyEntity> listUserFollow = new ArrayList<>();
	static List<RecruitmentEntity> listUserApplied = new ArrayList<>();
	static List<RoleEntity> roles = new ArrayList<>();
...
//		roles = user.getAuthorities();
		for(Applyjob a : user.getListAppliedOfUser()) {
			logger.info("List applied of user :  "+ a.toString());
